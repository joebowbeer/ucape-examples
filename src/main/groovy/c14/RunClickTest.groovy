...
def delay = JOptionPane.showInputDialog('Target visible period (2000 to 3500)?') as int
...
def procList = targetList + mouseBuffer + mouseBufferPrompt + targetManager +
    galleryProcess + displayControl + flusher + targetController + barrierManager
