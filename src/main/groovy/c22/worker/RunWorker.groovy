...
def w = JOptionPane.showInputDialog('Worker Number (3..20)?') as int
def emitterIP = JOptionPane.showInputDialog('Emitter Process IP?')
def collectorIP = JOptionPane.showInputDialog('Collector Process IP?')
